...
class SPECBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        path2 = example["file_path_"].replace('img','clue2d')
        ...
        example["specmap"] = clue['clue2d'][:,:,8:16].astype(np.float32).transpose((2,0,1))
    ...
    def _parse_data_list(self): # 80% / 10% / 10%
        ...
        train_imgs, val_imgs, test_imgs = all_imgs[:9000], all_imgs[9000:9200], all_imgs[9200:9300]
