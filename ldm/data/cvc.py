...
class CVCBase(Dataset):
    ...
    def __getitem__(self, i):
        ...
        #path2 = example["file_path_"].replace('train_256_smooth','clue_2d')
    ...
    def _parse_data_list(self): # 80% / 10% / 10%
        ...
        train_imgs, val_imgs, test_imgs = all_imgs[:4000], all_imgs[4000:4200], all_imgs[4300:4300]
        ...
        if self.mode == "train":
            ...
            test_imgs = glob.glob(os.path.join('D:/Brain-80-data/spectral/trainpng', "*.png"))
            return test_imgs
        else:
...
class CVCTrain(CVCBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="D:/Brain-80-data/spectral/trainpng", mode="train")#, **kwargs


class CVCValidation(CVCBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="D:/Brain-80-data/spectral/trainpng", mode="val")


class CVCTest(CVCBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="D:\chest-data-origin/final\img2d", mode="test")
